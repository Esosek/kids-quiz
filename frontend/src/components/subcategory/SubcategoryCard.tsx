...
export default function SubcategoryCard({ subcategoryId }: SubcategoryCardProps) {
  ...
  return (
    <li className='relative text-center w-full bg-pink-300 pt-6 pb-10 px-8 rounded-2x flex flex-col gap-5 justify-between items-center shadow-xl rounded-2xl sm:px-6'>
